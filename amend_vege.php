...
$id=$_GET['id'];
$sql0="select * from vegetable_message where id= $id ";
...
?>
	...
	<p>
	    ...
	    <span class="sp2">
			<input  name="ori" type="text" value="<?php echo $ori; ?>"  >
	    </span>
	</p>
	<p>
		<span class="sp1">批发价：
	    ...
	    <span class="sp2">
			<input  name="pur" type="text" value="<?php echo $pur; ?>" >
	    </span>
	</p>
	<p>
		<span class="sp1">建议零售价：</span>
		<span class="sp2">
			<input  name="sell" type="text" value="<?php echo $sell; ?>">
