...
if($currentPage==1){
    ...
    echo "<a href=vege_message.php?p=1><button class='bt3' >首页</button></a> | <a href=vege_message.php?p={$pageUp}><button class='bt3' >上一页</button></a> |";
	}
	
if($currentPage==$pageCount){	
	echo " <button class='bt4' >下一页</button> | <button class='bt4' >尾页</button>"; 
}else{
    echo " <a href=vege_message.php?p={$pageDn}><button class='bt3' >下一页</button></a> | <a href=vege_message.php?p={$pageCount}><button class='bt3' >尾页</button></a>";
	}
